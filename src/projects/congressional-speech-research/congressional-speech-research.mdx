...
This was a research project done during a Frshman-level class where we applied various text analysis metrics to US congressional speeches.
...
![Plot of the average sentence length in speeches over time](./sentence-length-mean.png)

![Plot of the frequency of words referring to women in speeches over time](./female-frequency.png)

![Plot of the frequency of words referring to energy in speeches over time](./energy-frequency.png)
