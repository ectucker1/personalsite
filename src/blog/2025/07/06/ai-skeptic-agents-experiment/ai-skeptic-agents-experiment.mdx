...
import TimeNote from '@components/TimeNote.astro';
import Video from '@components/Video.astro';
import wheatMachineDemo from './wheat-machine-demo.mp4';

<TimeNote>
    **2026**: This post is pretty out of date - I now work with agents pretty regularly!
    Mostly I needed time and experience to get to trust them.
</TimeNote>
...
<Video src={wheatMachineDemo} alt="The Electric Wheat Machine playing some acid-ish music." />
...
![Screenshot of Zed's agent panel output, showing the agent checking for compiler errors, then implementing a trait to fix one.](./zed-agent-output-example.png)
...
![Screenshot of the parmeter editors in Electric Wheat Machine, showing the new COND parameter.](./wheat-machine-offset-padding.png)
